...
print('The following python script obtains  M_200m given M_200c and the same properties as the previous example')

import hydro_mc
M_200m = hydro_mc.mass_from_mm_relation('200m','200c', M=1e14, a=0.9,omega_m = 0.2, omega_b = 0.04, sigma8=0.7, h0=0.7)
print('M_200m(M_200c=1e14Msun, a=0.9) = %e Msun'%M_200m)
print('')
