...
print('')
print('The following python script obtains the 200c concetration of  a halo with M_200c=1e14Msun halo at a=0.9,')
print('with a cosmology (omega_m = 0.2, omega_b = 0.04, sigma8=0.7, h0=0.7).')
print('The conversion uses the relation in Table A1 of Ragagnin et al. (2020).')

import hydro_mc
c_200 = hydro_mc.concentration_from_mc_relation(
                          '200c', M=1e14, a=0.9,
